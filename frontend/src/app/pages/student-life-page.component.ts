...
export class StudentLifePageComponent {
  ...
  readonly pillars = [
    {
      ...
      cta: 'Housing & residence colleges',
    },
    {
      photo: 'assets/student-life-wellbeing-support.jpg',
      ek: '02 â€” Wellbeing & counselling',
      h: 'Quiet, confidential support â€” built in.',
    ...
    },
    {
      ...
      ek: '03 â€” Societies & debate',
      h: 'Forty-plus student societies, run by students.',
      p: "Debate, language, faith, music, journalism, model-AU, and a continental scholars' network â€” funded annually with public budgets.",
      cta: 'Browse societies',
    },
    {
      photo: 'assets/student-life-athletics-field.jpg',
      ek: '04 â€” Athletics & movement',
    ...
    },
    {
      ...
      ek: '05 â€” Faith & reflection',
      h: 'An interfaith chaplaincy â€” serious and unhurried.',
  ...
  readonly voices = [
    {
      quote:
        'I came to Sankofa to write about how my grandmother understood medicine. Three years in, that question has become a real research programme â€” and a community that takes it seriously.',
      img: 'assets/student-voice-diana.jpg',
      name: 'Diana Kaija',
      meta: 'MA Indigenous Knowledge Systems â€” Class of 2027',
    },
    {
      quote:
        'The Pan-African scholarsâ€™ network was the first place I met students from Ghana, Senegal, and Ethiopia who think the way I do about African economies. The reading group has been running for two years now.',
      img: 'assets/student-voice-chinaza.jpg',
      name: 'Chinaza Ekeoma',
      meta: 'BA Civilizational Studies â€” Class of 2026',
    },
    {
      quote:
      ...
      meta: 'BSc Public Health â€” Class of 2028',
    },
  ];
  ...
  readonly calendar = [
    {
      day: '14',
      mon: 'MAR',
      h: 'Annual Lecture â€” Restoration as a research method',
    ...
    },
    {
      ...
      p: "Open seminar on NgÅ©gÄ© wa Thiong'o's Decolonising the Mind. Hosted by the Society of African Letters.",
      meta: '17:00 â€” Senior Common Room',
      action: 'Add to calendar',
    },
    {
      day: '22',
      mon: 'MAR',
      h: 'Health & wellbeing fair',
      p: 'Drop-in clinics, mental-health screenings, peer-support sign-ups, and a free strength class.',
      meta: '10:00 â€” 16:00 â€” Quad',
      action: 'Details',
    },
    {
      day: '29',
      ...
      meta: '19:00 â€” Senate Hall',
      action: 'Tickets',
    },
    {
      day: '02',
      mon: 'APR',
      h: "Founders' Day â€” Service of restoration",
      p: 'A public service of music, prayer, and reading. Interfaith chaplaincy, all students and families welcome.',
      meta: '11:00 â€” Chapel of the Three Rivers',
      action: 'Details',
    },
  ];
}
